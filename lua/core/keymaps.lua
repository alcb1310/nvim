...
vim.keymap.set({ 'i', 'v' }, 'fd', '<Esc>', { desc = 'Escape', silent = true })
vim.keymap.set({ 'i', 'v' }, 'df', '<Esc>', { desc = 'Escape', silent = true })
...
vim.keymap.set('n', '<leader>pu', vim.pack.update, { desc = '[P]ack [U]pdate', silent = true })
